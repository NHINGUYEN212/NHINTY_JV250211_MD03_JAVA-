...
public class Main {
    public static void main(String[] args) {
        ...
        List<Student> filteredStudents = students.stream().filter(student -> student.getGrade() > 7).sorted(Comparator.comparing(Student::getName)).toList();

        System.out.println("Danh sách các sinh viên có điểm lớn hơn 7.0, sắp xếp theo tên:");
